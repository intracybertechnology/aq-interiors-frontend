...
import { LayoutDashboard, Mail,LogOut,Menu,X,Search,Edit,Trash2,Plus,FileText,FolderKanban,Eye,EyeOff } from 'lucide-react';
                        ...
                        <tr key={blog._id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div className="flex items-center space-x-2">
                              ...
                              {/* {blog.isPublished && (
                                <button
                                  onClick={() => handleUnpublish(blog._id, blog.title)}
