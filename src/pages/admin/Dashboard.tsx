        ...
        <div className="h-full flex flex-col">
          ...
          <nav className="flex-1 p-4">
            <Link
              ...
              style={{ backgroundColor: '#9B4F96', color: 'white' }}
            >
        ...
        <header className="bg-white shadow-sm">
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center space-x-4">
              ...
              <h2 className="text-2xl font-bold text-gray-800" style={{ fontFamily: '"Lucida Bright", Georgia, serif' }}>Dashboard</h2>
            </div>
            <div className="flex items-center space-x-4">
            ...
            <>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <div className="p-4 border-t border-gray-200 text-center">
                  <Link to="/admin/enquiries" className="text-sm font-medium hover:underline"
