...
const Company: React.FC = () => {
  ...
  const breadcrumbs = [
    ...
    { name: 'About Us', url: 'https://www.aqdecor.com/about' }
  ];

  // Organization structured data with detailed info
  const organizationData = {
    ...
    "description": "Commercial fit-out and interior solutions company based in Sharjah, UAE. Founded in 2014 with 100+ employees and 1000+ completed projects.",
    "foundingDate": "2014",
    "numberOfEmployees": {
    ...
    <>
      ...
      <StructuredData
        data={{
          ...
          "mainEntity": {
            "@type": "Organization",
            "name": "AL QETHAA AL QADEEMA L.L.C.",
            "description": "Founded in 2014 and based in Sharjah, UAE, Al Qethaa Al Qadeema L.L.C. is a trusted name in the fit-out and interior solutions industry."
          },
          "url": "https://www.aqdecor.com/about"
        }}
      />
