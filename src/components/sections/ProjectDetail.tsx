      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
        ...
        <div className="container mx-auto px-4 lg:px-8 pb-8">
          <div className="flex flex-wrap items-center gap-4 mb-6">
            <span
              className="px-4 py-2 bg-gradient-to-r from-[#9B4F96] to-[#c96bb3] text-white rounded-full text-sm font-semibold shadow-lg"
              style={{ fontFamily: '"Lucida Bright", Georgia, serif' }}
            >
              {project.category}
            </span>
          ...
          <h1
            className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-[#9B4F96] via-[#c96bb3] to-[#9B4F96] bg-clip-text text-transparent"
            style={{ fontFamily: '"Lucida Bright", Georgia, serif' }}
          >
            {project.title}
          </h1>
        ...
        <div className="container mx-auto px-4 lg:px-8 pb-12">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            <h2
              className="text-3xl font-bold mb-8 text-[#9B4F96]"
              style={{ fontFamily: '"Lucida Bright", Georgia, serif' }}
            >
              Project Information
            </h2>
