...
const Projects: React.FC = () => {
  ...
  // SEO Configuration
  const projectsSEO = {
    title: 'Our Projects - Interior Design Portfolio | AQ Decor UAE',
    description: 'Browse 750+ completed interior design and fit-out projects across UAE. Commercial, retail, residential, healthcare & hospitality spaces. View our portfolio of premium interiors.',
    keywords: 'interior design portfolio UAE, completed projects UAE, commercial fit-out projects, retail interior design, residential projects UAE, hospitality design portfolio, AQ Decor projects',
    canonical: 'https://www.aqdecor.com/projects',
    ogImage: 'https://www.aqdecor.com/images/projects-og.jpg'
  };
    ...
    <>
      ...
      <StructuredData
        data={{
          ...
          "description": "Browse our portfolio of completed interior design and fit-out projects across UAE",
          "url": "https://www.aqdecor.com/projects",
          "provider": {
            "@type": "Organization",
            "name": "AQ Decor",
          ...
          data={{
            ...
            "itemListElement": displayedProjects.map((project, index) => ({
              ...
              "item": {
                ...
                "url": `https://www.aqdecor.com/projects/${project.id}`
              }
            }))
          }}
        />
