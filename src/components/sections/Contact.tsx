...
const Contact: React.FC = () => {
  ...
  // SEO Configuration
  const contactSEO = {
    title: 'Contact Us - AQ Decor | Interior Design & Fit-out Solutions in UAE',
    description: 'Get in touch with AQ Decor for premium interior design and fit-out services in UAE. Contact us for a free consultation and quote.',
    keywords: 'contact AQ Decor, interior design consultation UAE, fit-out services contact, Sharjah interior design',
    canonical: 'https://www.aqdecor.com/contact',
    ogImage: 'https://www.aqdecor.com/images/contact-og.jpg'
  };
  ...
  const contactInfo = [
    {
      ...
      href: `tel:${locationData?.phone || '+971561001190'}`,
    ...
    },
    {
      icon: MapPin,
      title: 'Location',
      details: [locationData?.address || 'Sharjah, United Arab Emirates', 'Visit our factory & office'],
    ...
    },
    {
      icon: Clock,
      title: 'Working Hours',
      details: locationData?.workingHours ? locationData.workingHours.split(',') : ['Mon-Fri: 8AM-6PM', 'Sat: 9AM-2PM'],
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#9B4F96] focus:border-transparent transition-all duration-300"
