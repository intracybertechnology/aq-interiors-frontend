...
const Blog: React.FC = () => {
  ...
  // SEO Configuration
  const blogSEO = {
    title: 'Interior Design Blog - Tips, Trends & Ideas | AQ Decor UAE',
    description: 'Explore the latest interior design trends, expert tips, and creative ideas from AQ Decor. Stay updated with design insights for commercial, retail, and residential spaces in UAE.',
    keywords: 'interior design blog UAE, design trends UAE, interior tips, commercial design ideas, retail design inspiration, home decor UAE, design insights',
    canonical: 'https://www.aqdecor.com/blog',
    ogImage: 'https://www.aqdecor.com/images/blog-og.jpg'
  };
    ...
    const fetchBlogs = async () => {
      ...
      try {
        ...
        if (data.blogs.length > 0) {
          console.log('Image from API:', data.blogs[0].image);
          console.log('Full image URL:', `${BASE_URL}${data.blogs[0].image}`);
        }
        console.log('======================');
    ...
    <>
      ...
      <StructuredData
        data={{
          ...
          "@type": "Blog",
          "name": "AQ Decor Design Blog",
          "description": "Interior design tips, trends, and insights from AQ Decor experts",
          "url": "https://www.aqdecor.com/blog",
          "publisher": {
            "@type": "Organization",
            "name": "AQ Decor",
            ...
            "logo": {
              "@type": "ImageObject",
              "url": "https://www.aqdecor.com/logo.png"
            }
          }
        }}
      />
          ...
          data={{
            ...
            "itemListElement": blogPosts.map((post, index) => ({
              ...
              "item": {
                ...
                "url": `https://www.aqdecor.com/blog/${post.slug || post._id}`
              }
            }))
          }}
        />
